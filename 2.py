...
ask2 = st.text_input("Do you have any questions? (yes / no)", key="ask_2")

if ask2.lower() == "no":
    st.write("Moving on ✅")

elif ask2.lower() == "yes":
    question2 = st.text_input("Please type your question", key="question_input_2")

    if question2:
        response2 = client.models.generate_content(
            model="gemini-2.0-flash",
            contents=question2 + "Make it pretty short at max 1 paragraph."
        )
...
if st.button("Next topic ▶"):
    st.switch_page("pages/3.py")  # use correct path
